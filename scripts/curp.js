function generarCURP () {
	...
	var primerAp = document.getElementById('txtApellidoPaterno').value;
	var segundoAp = document.getElementById('txtApellidoMaterno').value;
	var sexo = document.getElementById('rb_h').value;
	var fechaNacimiento = document.getElementById('fechaDeNAcimiento').value;
	var estado = document.getElementById('LugarDeNAcimiento').selectedIndex;
